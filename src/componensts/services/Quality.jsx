    ...
    <div className="bg-[#070707] bg-home-bg">
      <div className="max-w-[1300px] py-[152px] mx-auto flex flex-col items-center">
        <div className="text-center">
          <p className="text-[#fff] font-CU text-[23px] font-bold leading-[30px]">
            Serving Quality
          </p>
          ...
          <h5 className="text-[#DCCA87] font-CU text-[64px] leading-[84px] tracking-[1.39px] capitalize">
        ...
        <div className="flex gap-x-10">
          <Link>
            <button className="w-[137px] py-2 text-black bg-[#DCCA87] font-OS border border-transparent hover:border-[#DCCA87] hover:bg-transparent transition-all duration-300 hover:text-[#fff]">
              Read More
            </button>
          </Link>
