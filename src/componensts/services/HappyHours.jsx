...
const HappyHours = () => {
  ...
  return (
    <div className="w-full bg-[#070707] bg-home-bg">
      <Slider {...settings}>
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-40 transition-all duration-300 group">
            <div>
              <p className="text-[#DCCA87] text-[128px] font-CU font-semibold leading-[166.4px] tracking-[3.84px] capitalize">
                Happy Hours
              </p>
              <p className="text-[#fff] text-[32px] font-CU font-bold leading-[41.6px] tracking-[1.28px] capitalize text-center">
